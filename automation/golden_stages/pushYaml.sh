...
echo "MOVING UPDATED stage.yaml FILE"
...
/usr/bin/git add src/main/resources/config/stages.yaml
/usr/bin/git commit -m "AEAT-591 stages, rules and tasks added into stage.yaml file"
