                                ...
                                "Anchore": {
                                    script {
                                        if (env.ANCHORE_ENABLED == "true") {
                                            sh "${bob} anchore-inline-scan"
                                            archiveArtifacts 'build/va-reports/anchore-reports/**.*'
                                            archiveArtifacts 'anchore_metadata.properties'
                                        }
                                    }
                                }
                        )
...
def modifyBuildDescription() {
    def CHART_NAME = "eric-oss-ms-maturity-visualisation"
    def DOCKER_IMAGE_NAME = "eric-oss-ms-maturity-visualisation"
