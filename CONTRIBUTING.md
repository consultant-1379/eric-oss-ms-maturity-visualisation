...
Microservice Chassis artifacts are stored in the Gerrit project: [OSS/com.ericsson.oss.ci/eric-oss-ms-maturity-visualisation](https://gerrit-gamma.gic.ericsson.se/#/admin/projects/OSS/com.ericsson.oss.ci/eric-oss-ms-maturity-visualisation)
  
### Documents

The documentation for this service is located in the [doc folder](https://gerrit-gamma.gic.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci/eric-oss-ms-maturity-visualisation/+/master/doc).

To update documents that are not in the referenced folder, contact the service guardians mentioned in the [README.md](https://gerrit-gamma.gic.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci/eric-oss-ms-maturity-visualisation/+/master/README.md).
...
The code-review scores and corresponding workflow activities are as follows:
   ...
   [README.md] (https://gerrit-gamma.gic.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci/eric-oss-ms-maturity-visualisation/+/master/README.md)