...
import com.ericsson.oss.ci.jenkins.JenkinsProviderBuilder;
...
public class HealthCheckTest {
    ...
    @MockBean
    private JenkinsProviderBuilder jenkinsProviderBuilder;
    @MockBean
    private JenkinsProvider jenkinsProvider;
    @MockBean
    private LdapHealthIndicator ldapHealthIndicator;
    @Autowired
